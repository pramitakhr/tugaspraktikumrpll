<?php
   if (isset($_POST['upload'])){
      ...
      if (!empty($uFile)){
         ...
         mysqli_query($GLOBALS["___mysqli_ston"], "insert into tugas values('','$_POST[judul]', '$newFileName', '$_POST[deskripsi]', '$_POST[mapel]')");
...
<section class="register">
  <h3>Upload File Tugas Kuliah</h4>
  <hr>
  <br>
  <br>
  <form method="post" action="?halaman=upload_tugas" method="post" enctype="multipart/form-data" />
